...
// Lazy-load the animated background so it doesn't run during initial page load.
...
export default function Projects() {
  return (
    <>
      {/* Animated background is lazy and wrapped in Suspense to avoid blocking */}
        ...
        >
          ...
          <div className="flex flex-col gap-14 text-left">
            {projects.map((project) => (
              ...
              >
                <Card className="border-2 border-black/10 bg-white text-gray-800 shadow-md rounded-4xl hover:shadow-xl flex-1 flex flex-col justify-between">
                  <CardHeader>
